        ...
        <div className="dropdown dropdown-end">
          ...
          >
            <li className="group-custom">
              <h1 className="text-base capitalize hover:text-secondary-variant">{`Welcome ${user?.name}!`}</h1>
            </li>
            <li className="group-custom" onClick={updateProfile}>
              <a className="justify-between text-base group-custom-hover:text-secondary-variant">
                Profile
